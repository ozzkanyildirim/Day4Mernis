...
public class BGEKPSPublicSoap
{
    ...
    public BGEKPSPublicSoap(){}

    public BGEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BGEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BGEExtendedSoapSerializationEnvelope envelope= new BGEExtendedSoapSerializationEnvelope(BGEExtendedSoapSerializationEnvelope.VER11);
