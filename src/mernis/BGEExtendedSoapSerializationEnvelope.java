...
public class BGEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BGEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BGEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BGEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BGEDateTimeConverter dateTimeConverter = new BGEStandardDateTimeConverter();

    public BGEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BGEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BGEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BGEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BGEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BGEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
